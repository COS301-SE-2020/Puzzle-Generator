...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppPagesCreateCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    CreateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_2__["NavbarComponent"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_3__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_3__["DefaultLayoutGapDirective"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardHeader"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardContent"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_5__["MatRadioGroup"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_5__["MatRadioButton"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardActions"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButton"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardTitle"]],
  ...
  function srcAppPagesProfilePuzzlesProfilePuzzlesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ProfilePuzzlesComponent_div_2_mat_card_4_button_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfilePuzzlesComponent_div_2_mat_card_4_button_7_Template_button_click_0_listener() {
    ...
    function ProfilePuzzlesComponent_div_2_mat_card_4_button_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfilePuzzlesComponent_div_2_mat_card_4_button_8_Template_button_click_0_listener() {
    ...
    ProfilePuzzlesComponent.ɵfac = function ProfilePuzzlesComponent_Factory(t) {
      return new (t || ProfilePuzzlesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_api_service__WEBPACK_IMPORTED_MODULE_1__["APIService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };

    ProfilePuzzlesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfilePuzzlesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        value: function openRateDialog() {
          ...
          this.rateDialogRef.afterClosed().subscribe(function (result) {
            if (result != "") {
              _this4.ratingEntry = {
                //"id":this.rateUID,
                "puzzleID": _this4.ratePID,
                "rating": result,
                "token": localStorage.getItem('token')
              };
              console.log(_this4.ratingEntry);

              if (_this4.api.createNewPuzzleRating(_this4.ratingEntry).subscribe()) {
                alert("Rating added");
              }
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function updateName() {
          ...
          if (this.nameTextboxValue != undefined) {
            ...
            this.api.updateName(this.currentUser).subscribe(function (data) {
              _this5.currentUserObject['name'] = data['name'];
            });
            alert("Name updated");
          } else {
        ...
        value: function updateUsername() {
          ...
          if (this.usernameTextboxValue != undefined) {
            ...
            this.api.updateUsername(this.currentUser).subscribe(function (data) {
              _this6.currentUserObject['username'] = data['username'];
            });
          } else {
            console.log("No value provided");
          }
        ...
        value: function ngOnInit() {
          ...
          this.api.getUser(this.currentUser).subscribe(function (data) {
            _this7.currentUserObject = data;
            _this7.updateNameForm = _this7.formBuilder.group({
            ...
            _this7.updateUsernameForm = _this7.formBuilder.group({
        ...
        value: function openRateDialog() {
          ...
          this.rateDialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result != "") {
              ...
              console.log(_this10.ratingEntry);
          ...
          if (this.doPasswordsMatch(this.resetPasswordForm.controls['password'].value, this.resetPasswordForm.controls['confirmPassword'].value) == true) {
            ...
            if (this.verifyUser != null) {
              this.api.resetPassword(this.verifyUser).subscribe(function () {}, function (error) {
                if (error.status >= 401) {
                  _this12.formError = error.error;
                } else {
                  _this12.router.navigate(['/resetSuccess', {
  ...
  function srcAssetsJsManualCreationJs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "setGenerateButtonClicked", function () {
      return setGenerateButtonClicked;
    });
    /* harmony export (binding) */
    ...
    var siteBoundaries = [];
    var precision = 0;
    var colors = ['Plum', 'Tomato', 'Orange', 'Violet', 'Gray', 'MediumSeaGreen', 'LightGray', 'SlateBlue', 'Brown', 'Aquamarine', 'AntiqueWhite', 'Red', 'Green'];
    ...
    function createPoint(x, y) {
      ...
      point.on('dblclick', function (event) {
        console.log('double clicked!'); // layer.remove(point);
