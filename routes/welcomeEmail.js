module.exports = {
  generateWelcomeEmail:function (username){
    let message = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\n" +
      ...
      "        <h1 style=\"Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 32px;line-height: 40px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;text-align: center;\"><strong>Welcome to Prometheus Puzzles.</strong></h1><p style=\"Margin-top: 20px;Margin-bottom: 0;\">Hi friend,</p><p style=\"Margin-top: 20px;Margin-bottom: 0;\">We're excited to have you on board, you are now part of a whole community of puzzle makers, creating new and fascinating puzzles. We&#8217;re glad to have you, and excited to see what you create!</p><p style=\"Margin-top: 20px;Margin-bottom: 0;\">To start creating and sharing your new designs, please verify your account.</p><p style=\"Margin-top: 20px;Margin-bottom: 0;\">Verifying your account allows you to share your new creations as well as rate a range of creations from many other users in the \n" +
      "community.</p><p style=\"Margin-top: 20px;Margin-bottom: 20px;\">Click here to verify</p>\n" +
      "      </div>\n" +
      "    </div>\n" +
      "            \n" +
      "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\n" +
      "      <div class=\"btn btn--flat btn--large\" style=\"Margin-bottom: 20px;text-align: center;\">\n" +
      "        <![if !mso]><a style=\"border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #15b05e;font-family: Karla, Calibri, Geneva, sans-serif;\" href=\"https://prometheuspuzzles.herokuapp.com/api/verify/"+username+"\">VERIFY</a><![endif]>\n" +
      "      <!--[if mso]><p style=\"line-height:0;margin:0;\">&nbsp;</p><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" href=\"https://prometheuspuzzles.herokuapp.com/api/verify/:[username]\" style=\"width:94px\" arcsize=\"9%\" fillcolor=\"#15B05E\" stroke=\"f\"><v:textbox style=\"mso-fit-shape-to-text:t\" inset=\"0px,11px,0px,11px\"><center style=\"font-size:14px;line-height:24px;color:#FFFFFF;font-family:Karla,Calibri,Geneva,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px\">VERIFY</center></v:textbox></v:roundrect><![endif]--></div>\n" +
      "    </div>\n" +
      "            \n" +
      "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\n" +
